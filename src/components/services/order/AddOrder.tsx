...
const ServiceOrder = (props: any) => {
  ...
  useEffect(() => {
    const service = _.filter(
      serviceDetails,
      (serviceDetails) =>
        serviceDetails.categoryId === serviceOrderView.categoryId
    );
                                      ...
                                      <FormGroup>
                                        ...
                                        <Col sm="8">
                                          ...
                                          >
                                            ...
                                            {getYear && getYear.length ? (
                                              getYear.map((year: any) => {
                                                return (
                                                  <option value={year}>
                                                    {year}
                                                  </option>
                                    ...
                                    <FormGroup>
                                      ...
                                      <Col sm="9">
                                        <input
                                          ...
                                          name="time"
                                          value={moment
                                            .utc(serviceOrderView.timeStart)
                                            .format("LT")}
                                          disabled
                                        />
                                      </Col>
